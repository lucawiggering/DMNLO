...
command  = './../../../dmnlo {} --renscheme 1 --legacy --particleA 1000022 --particleB 1000006 --particle1 6 --particle2 21 --pcm {} {}'
...
plt.title(r'$\tilde{\chi}\tilde{t}\to t g$ legacy')
plt.plot(pcm,tree,label='LO check')
plt.plot(pcm,tree+dNLO,label='NLO check',alpha=0.5)

plt.xlabel(r'$p_{\rm cm}$ [GeV]')
plt.legend()
plt.savefig('Fig7_legacy.pdf')