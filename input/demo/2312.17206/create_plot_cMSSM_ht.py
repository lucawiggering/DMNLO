...
muR = 1368.2
command = './../../../dmnlo {} --renscheme 1 --slha {} --muR {} --particleA 1000022 --particleB 1000006 --particle1 25 --particle2 6 --pcm {} {}'
...
vsLO_half_mu,vsNLO_half_mu = compute(muR/2,'cMSSM_half_mu.spc')
vsLO,vsNLO = compute(muR,'cMSSM.spc')
vsLO_2mu,vsNLO_2mu = compute(2*muR,'cMSSM_2mu.spc')
...
sigma= sqrtS*(pcm/sqrtS)**2*kv(1,sqrtS/T)
print(sigma)
...
pcm_MO,s_MO = np.loadtxt('cMSSM_MO_ht.txt',unpack=True)
...
plt.figtext(0.745, 0.3,r'$\tilde{\chi}^0_1 \tilde{t}_1\to h^0 t$', fontsize=15, color=('black'))
