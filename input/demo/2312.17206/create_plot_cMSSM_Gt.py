...
muR = 1368.2
command = './../../../dmnlo {} --renscheme 1 --slha {} --muR {} --particleA 1000022 --particleB 1000006 --particle1 6 --particle2 21 --pcm {} {}'
...
pcm_MO,s_MO = np.loadtxt('cMSSM_MO_Gt.txt',unpack=True)
...
plt.figtext(0.745, 0.3,r'$\tilde{\chi}^0_1 \tilde{t}_1\to t g$', fontsize=15, color=('black'))
