...
muR = 1368.2
command = './../../../dmnlo {} --renscheme 1 --slha {} --muR {} --particleA 1000022 --particleB 1000006 --particle1 24 --particle2 5 --pcm {} {}'
...
pcm_MO,s_MO = np.loadtxt('cMSSM_MO_Wb.txt',unpack=True)
...
plt.figtext(0.718, 0.3,r'$\tilde{\chi}^0_1 \tilde{t}_1\to W^+ b$', fontsize=15, color=('black'))
