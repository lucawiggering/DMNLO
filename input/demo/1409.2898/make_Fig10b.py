...
command  = './../../../dmnlo {} --renscheme 1 --slha Scenario.spc --muR 1000 --particleA 1000022 --particleB 1000006 --particle1 6 --particle2 25 --pcm {} {}'
...
plt.plot(pcmCheck,vsNLOCheck*1e-8,color='purple',label='NLO pub')

plt.title(r'$\tilde{\chi}\tilde{t}\to t h$')
