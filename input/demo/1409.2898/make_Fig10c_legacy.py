...
command  = './../../../dmnlo {} --renscheme 1 --legacy --slha Scenario.spc --muR 1000 --particleA 1000022 --particleB 1000006 --particle1 5 --particle2 24 --pcm {} {}'
...
plt.title(r'$\tilde{\chi}\tilde{t}\to b W^+$ legacy')
